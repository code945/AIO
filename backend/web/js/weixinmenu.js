...
senparc.menu = {
    ...
    init: function () {
        ...
        $('#btnGetMenu').click(function () {
            ...
            $.getJSON('/Admin/Weixin/GetMenu?t=' + Math.random(), { token: senparc.menu.token }, function (json) {
                if (json.menu) {
        ...
        $('#btnDeleteMenu').click(function () {
            ...
            $.getJSON('/Admin/Weixin/DeleteMenu?t=' + Math.random(), {  }, function (json) {
                if (json.Success) {
...
$(document).ready(function () {
    $("#menu_weixin_menu").parent().parent().addClass("active");
    $("#menu_weixin_menu").parent().addClass("menu-open");
    $("#menu_weixin_menu").addClass("active");
    senparc.menu.init();
});